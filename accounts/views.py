...
from .mixins import AuthorAccessEditProfileMixin
import ghasedak
...
def activate(request, uidb64, token): # Activated the send code to user and true an is_active 
...
class UserEditProfileView(AuthorAccessEditProfileMixin, View):
